...
CREATE TABLE dwh.DWH_Programme_validation_request (
    programme_sk     INT IDENTITY(1,1) PRIMARY KEY, 

    ID_src           NUMERIC(38,0) NOT NULL,
    DATE_DEPOT       INT,
    DEMANDEUR        VARCHAR(50),
    TYPE_DEMANDE     VARCHAR(50),
    ID_FILIERE_SK       INT NOT NULL,
    APPROCHE         VARCHAR(20),
    NOUVELLE_FILIERE SMALLINT,
    DATE_VALIDATION  INT,
    ID_PROVINCE_SK      NUMERIC(38,0),

    DATE_CREATION    DATETIME DEFAULT GETDATE(),  
    DATE_MAJ         DATETIME NULL,               
    ISACTIF          BIT DEFAULT 1,

    CONSTRAINT FK_DWH_Programme_Filiere FOREIGN KEY (ID_FILIERE_SK) 
        REFERENCES [dwh].[DWH_FILIERE](FILIERE_SK),
		 CONSTRAINT FK_DWH_Programme_Province FOREIGN KEY (ID_PROVINCE_SK) 
        REFERENCES [dwh].[DWH_PROVINCE]([PROVINCE_SK])
